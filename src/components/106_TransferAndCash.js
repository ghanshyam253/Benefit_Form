...
export class TransferAndCash extends Component {

  constructor(props) {
    console.log(" TransferAndCash Details Component");
    super(props);
    console.log(props);
  ...
  continue = (e) => {
    ...
    this.nextPath("/retirementNew");
  };

  back = (e) => {
    e.preventDefault();
    this.props.handleNav(5);
    this.nextPath("./fullTransferOfBenefits");
  };
    ...
    return (
      <div>
        ...
        >
          ...
          >
            <div class="h2">Welcome to TransferAndCash Details page</div>
            <p />
          </li>
        ...
        >
          ...
          >
            ...
            <div className="footerPgNum">6/9</div>
          </li>
        </ul>
      </div>
    );
...
export default withRouter(TransferAndCash);

...
export class RetirementNew extends Component {

  constructor(props) {
    console.log(" Retirement Details Component");
    super(props);
    console.log(props);
    ...
    return (
      <div>
        ...
        >
          ...
          >
            <div class="h2">Welcome to Retirement Details page</div>
            <p />
          </li>
        ...
        >
          ...
          >
            ...
            <div className="footerPgNum">7/9</div>
          </li>
        </ul>
      </div>
    );
...
export default withRouter(RetirementNew);

...
import {EMPLOYER_DECLARATION} from "../constants/constants";
...
export class Declaration extends Component {
  ...
  saveDocumentPartially = (callback) => {
    this.props.handleSavedPages(EMPLOYER_DECLARATION, () => {
      let body = {
  ...
  validateData = (callback) => {
    if (
        this.props.values.fundAuthAck_emp === true &&
        this.props.values.fundAuthName_emp &&
        this.props.values.signature_emp
    ) {
      // this.props.handleSignature('signature_emp', this.state.imageBase64);
      ...
      if (this.props.values.fundAuthAck_emp === false) {
        this.setState({
      ...
      if (!this.props.values.fundAuthName_emp) {
        this.setState({
      ...
      if(!this.props.values.signature_emp) {
        this.setState({
  ...
  continue = (e) => {
    ...
    this.validateData((_nextPath, _nav) => {
      ...
      this.props.clearValidPage(EMPLOYER_DECLARATION);
    ...
    return (
      <div>
        ...
        >
          ...
          >
            <h2>Declaration (Acknowledgement by employer)</h2>
            <p />
          </li>
          ...
          >
            <label className="labelName">
              <span>Employer acknowledgement</span>
              <em className="important">*</em>
            </label>
              ...
              <div className="termsContainer">
                ...
                <div className="termsAccept">
                  <input
                    ...
                    type="checkbox"
                    onChange={handleChange("fundAuthAck_emp")}
                    checked={values.fundAuthAck_emp}
          ...
          >
            <label className="labelName">
              <span>Employer representative full name</span>
              <em className="important">*</em>
            </label>
            <div className="tempContDiv">
              <span>
                <input
                  type="text"
                  tabIndex="4"
                  value={values.fundAuthName_emp}
                  onChange={handleChange("fundAuthName_emp")}
                  autoComplete='nofill'
                  disabled={this.props.is_form_submitted}
                />
              </span>
          ...
          >
            {
              values.signature_emp ? (
                <>
                  <label className="labelName">
                    <span>Employer representative signature</span>
                    <em className="important">*</em>
                  </label>
                  <div className="tempContDiv">
          ...
          >
            ...
            {/* <div className="tempContDiv"><div className="signContainer" elname="signContainer" id="signContainer-Signature"><canvas id="drawingCanvas-Signature2" tabIndex={-1} width={728} />
                            <div className="signArea" id="sign-area-Signature" style={{display: 'none'}} /><a id="clearSign" className="instrSpace" href="javascript:void(0);" onClick="clearSignature('drawingCanvas-Signature2');">Clear</a></div><p className="errorMessage" elname="error" id="error-Signature" style={{display: 'none'}} />
                        </div> */}
            {/* <CanvasDraw
              canvasWidth="100%"
        ...
        >
          ...
          >
            ...
            <div className="clearBoth" />
            <div className="footerPgNum">12/14</div>
          </li>
        </ul>
      </div>
    );

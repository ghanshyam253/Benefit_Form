...
export class FullTransferOfBenefits extends Component {

  constructor(props) {
    console.log(" FullTransferOfBenefits Details Component");
    super(props);
    console.log(props);
    ...
    return (
      <div>
        ...
        >
          ...
          >
            <div class="h2">Welcome to FullTransferOfBenefits Details page</div>
            <p />
          </li>
        ...
        >
          ...
          >
            ...
            <div className="footerPgNum">5/9</div>
          </li>
        </ul>
      </div>
    );
...
export default withRouter(FullTransferOfBenefits);
